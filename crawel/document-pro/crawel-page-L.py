...
if __name__ == "__main__":
    ...
    for page in range(1, 51):
        url0 = "http://www.letpub.com.cn/index.php?page=grant&name=&person=&no=&company=&startTime=" + "1997" + "&endTime=" + "2013" + "&money1=&money2=&" \
                "subcategory=&addcomment_s1=L&addcomment_s2=&addcomment_s3=&addcomment_s4=&currentpage=" + str(page) + "#fundlisttable"
        queue.put(url0)

    for page in range(1, 51):
        url0 = "http://www.letpub.com.cn/index.php?page=grant&name=&person=&no=&company=&startTime=" + "2014" + "&endTime=" + "2015" + "&money1=&money2=&" \
                "subcategory=&addcomment_s1=L&addcomment_s2=&addcomment_s3=&addcomment_s4=&currentpage=" + str(page) + "#fundlisttable"
        queue.put(url0)

    for page in range(1, 51):
        url0 = "http://www.letpub.com.cn/index.php?page=grant&name=&person=&no=&company=&startTime=" + "2016" + "&endTime=" + "2016" + "&money1=&money2=&" \
                "subcategory=&addcomment_s1=L&addcomment_s2=&addcomment_s3=&addcomment_s4=&currentpage=" + str(page) + "#fundlisttable"
        queue.put(url0)

    for page in range(1, 51):
        url0 = "http://www.letpub.com.cn/index.php?page=grant&name=&person=&no=&company=&startTime=" + "2017" + "&endTime=" + "2018" + "&money1=&money2=&" \
                "subcategory=&addcomment_s1=L&addcomment_s2=&addcomment_s3=&addcomment_s4=&currentpage=" + str(page) + "#fundlisttable"
        queue.put(url0)
    ...
    with open("page-L.json", "w", encoding="utf-8") as fwrite:
